#ifndef SMARTFILES_DEBUG_HPP
#define SMARTFILES_DEBUG_HPP
...
#ifdef WIN32
#define __SMARTFILES_FUNCTION__ __FUNCSIG__ /* __FUNCDNAME__ */ 
#else
#define __SMARTFILES_FUNCTION__ __FUNCTION__ 
#endif

#define log_function() \
{ \
    std::stringstream _final_log_ss; \
    _final_log_ss << __SMARTFILES_FUNCTION__; \
    _final_log_ss << "()"; \
    _final_log_ss << "["; \
    _final_log_ss << __LINE__; \
    _final_log_ss << "][FUNCTION] - "; \
    smartfiles::logger::instance() << _final_log_ss.str(); \
}
